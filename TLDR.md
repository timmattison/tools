...
| `krt` | Knights of the Round Trip — records the network path to a destination, hop by hop, into an append-only JSONL file. `krt replay` summarizes one run of a recorded file. |
