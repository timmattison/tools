...
| `workit` | Builds a Cargo workspace manifest from a directory tree — finds every `Cargo.toml` that is a package rather than a workspace, writes those directories into the members list, and refuses duplicate package names. |
