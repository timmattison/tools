...
use clap::Parser;
use filewalker::{format_count, FileWalker, FilterType};
...
#[command(
    long_about = "Count files in the specified directories. If no paths are provided, counts files in the current directory."
)]
struct Cli {
