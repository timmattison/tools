...
async fn list_devices(
    ...
    let path = format!("/v1/sites/{}/devices", site_id);
...
async fn get_device(
    ...
    let path = format!("/v1/sites/{}/devices/{}", site_id, device_id);
...
async fn get_device_stats(
    ...
    let path = format!("/v1/sites/{}/devices/{}/statistics/latest", site_id, device_id);
...
async fn restart_device(
    ...
    let path = format!("/v1/sites/{}/devices/{}/actions", site_id, device_id);
...
async fn power_cycle_port(
    ...
    let path = format!("/v1/sites/{}/devices/{}/interfaces/ports/{}/actions", site_id, device_id, port_idx);
