...
use clap::Parser;
use filewalker::{format_bytes, FileWalker, FilterType};
...
#[command(
    long_about = "Calculate the total size of files in the specified directories. If no paths are provided, calculates size of files in the current directory."
)]
struct Cli {
